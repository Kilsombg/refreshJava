...
Задача 2: В класа CreateEvent напишете метод public void fillSchedule(Competition ob, Participant[] schedule),
 който инициализира списъка с участници и техните коефициенти. Ако списъкът е празен хвърля изключение
  EmptySetException.
...
Задача 3: Напишете статичен метод static void bets(Competition ob, int id, double bet),
 ...
 се сумира към събраната досега сума (betForWin) и се дели на предходната сума (betForWin).
 Коефициентът (chanceToWin) се променя като намалява с процента, получен от предишната операция.
 Коефициентът не може да бъде под 1.1. Ако новата стойност на chanceToWin e по-малка от стойността - 1.1,
